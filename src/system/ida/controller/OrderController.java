...
public class OrderController {
	...
	/**
	 * 주문 추가 기능을 처리할 메소드
	 * 가상주소 /order_insert.ida로 접근하면 호출
	 * @param orderDTO : 주문 DTO
	 * @param mi_names : 메뉴 이름들
	 * @param quantitys : 메뉴의 수량들
	 * @param session : HttpSession 객체
	...
	/**
	 * 주문 수정 화면을 보여줄 jsp와 주문 정보를 보여주는 메소드
	 * 가상주소 /order_update_form.ida로 접근하면 호출
	 * @param session : HttpSession 객체
	 * @param oi_no : 주문 번호
	 * @return mav : /order_update_form.ida에 맵핑되는 jsp 파일과 주문 정보 목록
	 */
	 ...
	 * @param order_update : 수정할 주문들
	 * @return update_result : 주문 수정 Query 실행 결과
	 */
	...
	public int updateStoreOrder(
		...
		try {
			...
			System.out.println("<updateStoreOrder 에러발생>");
			System.out.println(e.getMessage());
		}
	...
	/**
	 * 주문 삭제 화면을 보여줄 jsp와 주문 정보를 보여주는 메소드
	 ...
	 * @return delete_result : 주문 삭제 Query 실행 결과
	 */
	...
	public int deleteStoreOrder(
		...
		try {
			...
			System.out.println("<deleteStoreOrder 에러발생>");
			System.out.println(e.getMessage());
		}
	...
	/**
	 * 주문 분석 - 표 화면을 보여줄 jsp와 가게에 등록된 주문을 검색 조건에 따라 보여주는 메소드
	 * 가상주소 /order_analysis_form.ida로 접근하면 호출
	 * @param session : HttpSession 객체
	 * @param ordersearchDTO : 주문 검색 DTO
	...
	/**
	 * 주문 분석 - 차트 화면을 보여줄 jsp와 가게에 등록된 주문을 검색 조건에 따라 차트로 보여주는 메소드
	 * 가상주소 /order_analysis_chart_form.ida로 접근하면 호출
	 * @param flag : 초기 셋팅할 차트 구분
