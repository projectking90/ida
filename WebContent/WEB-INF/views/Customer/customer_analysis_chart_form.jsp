...
<%@ include file="/WEB-INF/resources/Customer/customer_analysis_chart_js.jsp"%>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
				...
				<div class="container-fluid">
					...
					<div class="card mb-3">
						<div class="card-header">
							<i class="fas fa-fw fa-chart-area"></i>고객 분석 차트
							<span name='customer_analysis_chart_btn' style='float:right'>
								<button type="button" class="btn btn-primary c_table">고객 표</button>
							</span>
						</div>
